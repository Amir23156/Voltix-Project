...
public class ZoneConsomationService {
    ...
    public List<ZoneConsomationModel> getZoneConsomationsBetweenDates(Date startDate, Date endDate, String id) {
        List<ZoneConsomationModel> instancesInDateRange = zoneConsomationRepository
                .findByDateBetweenAndZone_Id(startDate, endDate, id);

        return instancesInDateRange;
    }

    private String getDateTimeKey(ZoneConsomationModel zoneConsomation) {
        // Create a key based on the date and hour (you can adjust this format as
        // needed)
        return zoneConsomation.getDate().toString();
    }
